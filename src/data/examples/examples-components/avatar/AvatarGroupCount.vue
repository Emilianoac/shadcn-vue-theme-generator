...
<template>
  <div class="space-y-5">
    ...
    <div class="flex flex-row items-center">
      ...
      <Avatar class="w-6 h-6 border-2 border-background -ml-2">
        <AvatarFallback class="border text-xs text-muted-foreground">+3</AvatarFallback>
      </Avatar>
    </div>
    ...
    <div class="flex flex-row items-center">
      ...
      <Avatar class="w-8 h-8 border-2 border-background -ml-3">
        <AvatarFallback class="border text-sm text-muted-foreground">+3</AvatarFallback>
      </Avatar>
    </div>
    ...
    <div class="flex flex-row items-center">
      ...
      <Avatar class="w-10 h-10 border-2 border-background -ml-3">
        <AvatarFallback class="border text-muted-foreground">+3</AvatarFallback>
      </Avatar>
    </div>
  </div>
</template>
