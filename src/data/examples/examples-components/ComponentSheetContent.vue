...
interface ComponentSheetContentProps extends DialogContentProps {
...
const props = withDefaults(defineProps<ComponentSheetContentProps>(), {
  side: "right",
});
...
<template>
  <DialogPortal defer to="#examples-container">
    <SheetOverlay class="absolute" />
    <DialogContent
