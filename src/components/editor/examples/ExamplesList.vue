...
<template>
  ...
  <nav class="flex flex-col h-full bg-background overflow-y-auto">
    ...
    />
    <div class="overflow-y-auto flex-1 space-y-6 max-h-50 lg:max-h-none mt-4 mb-5">
      <div v-for="(group, groupKey) in filteredExamples" :key="groupKey">
        <p class="px-2 text-[10px] uppercase font-bold text-muted-foreground tracking-wider mb-2">
