...
import ControlsColor from "@/apps/main/components/editor/sidebar/tabs/colors/ColorsTab.vue";
import AutoGenerate from "@/apps/main/components/editor/sidebar/tabs/auto-generate/AutoGenerate.vue";
