import{_ as r}from"./CoppyButton.vue_vue_type_script_setup_true_lang-C44kN4yO.js";import{d as c,o as l,z as p,A as o,a3 as a,D as d,c as i}from"./DialogTitle.vue_vue_type_script_setup_true_lang-C_9FSQhf.js";function m(t){let e=t.replace(/["']data-component-x-ray(-trigger)?["']\s*:\s*["'][^"']*["'],?/g,"").replace(/\s*data-component-x-ray(-trigger)?="[^"]*"/g,"").replace(/,\s*,/g,",").replace(/,\s*}/g,"}").replace(/,\s*]/g,"]").replace(/\s*to="#examples-container"/g,"");for(;e.includes(`
