...
<style lang="postcss" scoped></style>
`,en=s({__name:"ButtonGroupWithDropdown",setup(p){return(u,e)=>(i(),f(n(l),null,{default:o(()=>[t(n(r),{variant:"outline","data-component-x-ray":"Button"},{default:o(()=>[...e[0]||(e[0]=[a(" Follow ",-1)])]),_:1}),t(n(z),null,{default:o(()=>[t(n(R),{"as-child":""},{default:o(()=>[t(n(r),{variant:"outline",size:"icon","data-component-x-ray-trigger":"Button"},{default:o(()=>[t(n(W))]),_:1})]),_:1}),t(n(A),{align:"end","data-component-x-ray":"DropdownMenuContent"},{default:o(()=>[t(n(x),null,{default:o(()=>[t(n(m),null,{default:o(()=>[t(n(J)),e[1]||(e[1]=a(" Mute Conversation ",-1))]),_:1}),t(n(m),null,{default:o(()=>[t(n(I)),e[2]||(e[2]=a(" Mark as Read ",-1))]),_:1}),t(n(m),null,{default:o(()=>[t(n(M)),e[3]||(e[3]=a(" Report Conversation ",-1))]),_:1}),t(n(m),null,{default:o(()=>[t(n(H)),e[4]||(e[4]=a(" Block User ",-1))]),_:1}),t(n(m),null,{default:o(()=>[t(n(q)),e[5]||(e[5]=a(" Share Conversation ",-1))]),_:1}),t(n(m),null,{default:o(()=>[t(n(h)),e[6]||(e[6]=a(" Copy Conversation ",-1))]),_:1})]),_:1}),t(n(V)),t(n(x),null,{default:o(()=>[t(n(m),{variant:"destructive"},{default:o(()=>[t(n(E)),e[7]||(e[7]=a(" Delete Conversation ",-1))]),_:1})]),_:1})]),_:1})]),_:1})]),_:1}))}}),an=`<script setup lang="ts">
import {
  AlertTriangleIcon,
  CheckIcon,
  ChevronDownIcon,
...
`,rn={class:"text-muted-foreground"},un=s({__name:"ButtonGroupWithSelect",setup(p){const u=[{value:"$",label:"US Dollar"},{value:"€",label:"Euro"},{value:"£",label:"British Pound"}],e=T("$");return(D,y)=>(i(),f(n(l),null,{default:o(()=>[t(n(l),null,{default:o(()=>[t(n(U),{modelValue:e.value,"onUpdate:modelValue":y[0]||(y[0]=c=>e.value=c)},{default:o(()=>[t(n(N),{class:"font-mono w-14","data-component-x-ray-trigger":"SelectTrigger"},{default:o(()=>[a(_(e.value),1)]),_:1}),t(n(P),{class:"min-w-24","data-component-x-ray":"SelectContent"},{default:o(()=>[(i(),B(k,null,$(u,c=>t(n(j),{key:c.value,value:c.value,"data-component-x-ray":"SelectItem"},{default:o(()=>[a(_(c.value)+" ",1),g("span",rn,_(c.label),1)]),_:2},1032,["value"])),64))]),_:1})]),_:1},8,["modelValue"]),t(n(v),{placeholder:"10.00",pattern:"[0-9]*","data-component-x-ray":"Input"}),t(n(r),{"aria-label":"Send",size:"icon",variant:"outline","data-component-x-ray":"Button"},{default:o(()=>[t(n(F))]),_:1})]),_:1})]),_:1}))}}),ln=`<script setup lang="ts">
...
`,pn=s({__name:"ButtonGroupWithIcons",setup(p){return(u,e)=>(i(),f(n(l),null,{default:o(()=>[t(n(l),null,{default:o(()=>[t(n(r),{size:"icon",variant:"outline","data-component-x-ray":"Button"},{default:o(()=>[t(n(L))]),_:1}),t(n(r),{size:"icon",variant:"outline","data-component-x-ray":"Button"},{default:o(()=>[t(n(M))]),_:1}),t(n(r),{size:"icon",variant:"outline","data-component-x-ray":"Button"},{default:o(()=>[t(n(I))]),_:1}),t(n(r),{size:"icon",variant:"outline","data-component-x-ray":"Button"},{default:o(()=>[t(n(h))]),_:1})]),_:1})]),_:1}))}}),sn=`<script setup lang="ts">
