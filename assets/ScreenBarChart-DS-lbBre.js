...
<template>
  <Card class="py-4 sm:py-0">
    ...
    <CardContent class="px-2 sm:p-6">
      <ChartContainer :config="chartConfig" class="aspect-auto h-62.5 w-full" cursor>
...
`,E={class:"flex gap-2 font-medium leading-none"},P=D({__name:"BarChartDefault",setup(b){const s=[{date:new Date("2024-01-01"),desktop:186},{date:new Date("2024-02-01"),desktop:305},{date:new Date("2024-03-01"),desktop:237},{date:new Date("2024-04-01"),desktop:73},{date:new Date("2024-05-01"),desktop:209},{date:new Date("2024-06-01"),desktop:214}],d={desktop:{label:"Desktop",color:"var(--chart-1)"}};return(m,o)=>(k(),B(e(x),null,{default:n(()=>[t(e(_),null,{default:n(()=>[t(e(v),null,{default:n(()=>[...o[0]||(o[0]=[r("Bar Chart",-1)])]),_:1}),t(e(y),null,{default:n(()=>[...o[1]||(o[1]=[r("January - June 2024",-1)])]),_:1})]),_:1}),t(e(g),null,{default:n(()=>[t(e(f),{config:d},{default:n(()=>[t(e(T),{data:s,margin:{left:-24},"y-domain":[0,void 0]},{default:n(()=>[t(e(V),{x:a=>a.date,y:a=>a.desktop,color:d.desktop.color,"rounded-corners":10},null,8,["x","y","color"]),t(e(c),{type:"x",x:a=>a.date,"tick-line":!1,"domain-line":!1,"grid-line":!1,"num-ticks":6,"tick-format":a=>new Date(a).toLocaleDateString("en-US",{month:"short"}),"tick-values":s.map(a=>a.date)},null,8,["x","tick-format","tick-values"]),t(e(c),{type:"y","num-ticks":3,"tick-line":!1,"domain-line":!1}),t(e(w)),t(e(S),{template:e(C)(d,e(h),{hideLabel:!0}),color:"#0000"},null,8,["template"])]),_:1})]),_:1})]),_:1}),t(e(H),{class:"flex-col items-start gap-2 text-sm"},{default:n(()=>[l("div",E,[o[2]||(o[2]=r(" Trending up by 5.2% this month ",-1)),t(e(L),{class:"h-4 w-4"})]),o[3]||(o[3]=l("div",{class:"leading-none text-muted-foreground"}," Showing total visitors for the last 6 months ",-1))]),_:1})]),_:1}))}}),q=`<script setup lang="ts">
import type { ChartConfig } from "@/components/ui/chart";
...
`,K={class:"flex gap-2 font-medium leading-none"},Q=D({__name:"BarChartHorizontal",setup(b){const s=[{date:new Date("2024-01-01"),desktop:186},{date:new Date("2024-02-01"),desktop:305},{date:new Date("2024-03-01"),desktop:237},{date:new Date("2024-04-01"),desktop:73},{date:new Date("2024-05-01"),desktop:209},{date:new Date("2024-06-01"),desktop:214}],d={desktop:{label:"Desktop",color:"var(--chart-1)"}};return(m,o)=>(k(),B(e(x),null,{default:n(()=>[t(e(_),null,{default:n(()=>[t(e(v),null,{default:n(()=>[...o[0]||(o[0]=[r("Bar Chart - Horizontal",-1)])]),_:1}),t(e(y),null,{default:n(()=>[...o[1]||(o[1]=[r("January - June 2024",-1)])]),_:1})]),_:1}),t(e(g),null,{default:n(()=>[t(e(f),{config:d},{default:n(()=>[t(e(T),{data:s},{default:n(()=>[t(e(V),{x:a=>a.date,y:a=>a.desktop,color:d.desktop.color,"rounded-corners":5,orientation:e(F).Horizontal},null,8,["x","y","color","orientation"]),t(e(c),{type:"y","tick-line":!1,"domain-line":!1,"grid-line":!1,"num-ticks":6,"tick-format":a=>new Date(a).toLocaleDateString("en-US",{month:"short"}),"tick-values":s.map(a=>a.date)},null,8,["tick-format","tick-values"]),t(e(w)),t(e(S),{template:e(C)(d,e(h),{hideLabel:!0}),color:"#0000"},null,8,["template"])]),_:1})]),_:1})]),_:1}),t(e(H),{class:"flex-col items-start gap-2 text-sm"},{default:n(()=>[l("div",K,[o[2]||(o[2]=r(" Trending up by 5.2% this month ",-1)),t(e(L),{class:"h-4 w-4"})]),o[3]||(o[3]=l("div",{class:"leading-none text-muted-foreground"}," Showing total visitors for the last 6 months ",-1))]),_:1})]),_:1}))}}),W=`<script setup lang="ts">
import type { ChartConfig } from "@/components/ui/chart";
...
`,Z={class:"flex gap-2 font-medium leading-none"},ee=D({__name:"BarChartMultiple",setup(b){const s=[{date:new Date("2024-01-01"),desktop:186,mobile:80},{date:new Date("2024-02-01"),desktop:305,mobile:200},{date:new Date("2024-03-01"),desktop:237,mobile:120},{date:new Date("2024-04-01"),desktop:73,mobile:190},{date:new Date("2024-05-01"),desktop:209,mobile:130},{date:new Date("2024-06-01"),desktop:214,mobile:140}],d={desktop:{label:"Desktop",color:"var(--chart-1)"},mobile:{label:"Mobile",color:"var(--chart-2)"}};return(m,o)=>(k(),B(e(x),null,{default:n(()=>[t(e(_),null,{default:n(()=>[t(e(v),null,{default:n(()=>[...o[0]||(o[0]=[r("Bar Chart - Multiple",-1)])]),_:1}),t(e(y),null,{default:n(()=>[...o[1]||(o[1]=[r("January - June 2024",-1)])]),_:1})]),_:1}),t(e(g),null,{default:n(()=>[t(e(f),{config:d},{default:n(()=>[t(e(T),{data:s},{default:n(()=>[t(e(V),{x:a=>a.date,y:[a=>a.desktop,a=>a.mobile],color:[d.desktop.color,d.mobile.color],"rounded-corners":4,"bar-padding":"0.15","group-padding":"0"},null,8,["x","y","color"]),t(e(c),{type:"x",x:a=>a.date,"tick-line":!1,"domain-line":!1,"grid-line":!1,"num-ticks":6,"tick-format":a=>new Date(a).toLocaleDateString("en-US",{month:"short"}),"tick-values":s.map(a=>a.date)},null,8,["x","tick-format","tick-values"]),t(e(c),{type:"y","num-ticks":3,"tick-line":!1,"domain-line":!1}),t(e(w)),t(e(S),{template:e(C)(d,e(h),{indicator:"dashed",hideLabel:!0}),color:"#0000"},null,8,["template"])]),_:1})]),_:1})]),_:1}),t(e(H),{class:"flex-col items-start gap-2 text-sm"},{default:n(()=>[l("div",Z,[o[2]||(o[2]=r(" Trending up by 5.2% this month ",-1)),t(e(L),{class:"h-4 w-4"})]),o[3]||(o[3]=l("div",{class:"leading-none text-muted-foreground"}," Showing total visitors for the last 6 months ",-1))]),_:1})]),_:1}))}}),te=`<script setup lang="ts">
import type { ChartConfig } from "@/components/ui/chart";
...
`,ne={class:"@container/area-chart-examples"},ae={class:"grid grid-cols-1 @4xl:grid-cols-3 gap-5"},Ce=D({__name:"ScreenBarChart",setup(b){return(s,d)=>(k(),U("div",ne,[l("div",ae,[t(u,{"raw-component":e(N),class:"@4xl:col-span-3"},{title:n(()=>[...d[0]||(d[0]=[r("Interactive Bar Chart",-1)])]),example:n(()=>[t(R)]),_:1},8,["raw-component"]),t(u,{"raw-component":e(q)},{title:n(()=>[...d[1]||(d[1]=[r("Default Bar Chart",-1)])]),example:n(()=>[t(P)]),_:1},8,["raw-component"]),t(u,{"raw-component":e(W)},{title:n(()=>[...d[2]||(d[2]=[r("Horizontal Bar Chart",-1)])]),example:n(()=>[t(Q)]),_:1},8,["raw-component"]),t(u,{"raw-component":e(te)},{title:n(()=>[...d[3]||(d[3]=[r("Multiple Bar Chart",-1)])]),example:n(()=>[t(ee)]),_:1},8,["raw-component"])])]))}});export{Ce as default};
