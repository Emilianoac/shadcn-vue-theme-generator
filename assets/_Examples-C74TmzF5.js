...
`,ya={class:"@container max-w-200 mx-auto"},xa={class:"grid grid-cols-1 @xl:grid-cols-2 gap-8 mx-auto"},Ea=g({__name:"_Examples",setup(s){return(n,a)=>(l(),z("div",ya,[q("div",xa,[u(S,{"raw-component":e(Pa)},{title:r(()=>[...a[0]||(a[0]=[c(" Basic ",-1)])]),example:r(()=>[u(fa)]),_:1},8,["raw-component"]),u(S,{"raw-component":e(_a)},{title:r(()=>[...a[1]||(a[1]=[c(" Simple ",-1)])]),example:r(()=>[u(va)]),_:1},8,["raw-component"])])]))}});export{Ea as default};
