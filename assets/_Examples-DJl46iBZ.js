...
`,U={class:"@container max-w-250 mx-auto"},F={class:"grid grid-cols-1 @xl:grid-cols-2 gap-8 mx-auto"},un=c({__name:"_Examples",setup(e){return(r,p)=>(i(),m("div",U,[b("div",F,[t(G,{"raw-component":n(W)},{title:o(()=>[...p[0]||(p[0]=[a(" Basic ",-1)])]),example:o(()=>[t(R)]),_:1},8,["raw-component"]),t(G,{"raw-component":n(D)},{title:o(()=>[...p[1]||(p[1]=[a(" With Button ",-1)])]),example:o(()=>[t(V)]),_:1},8,["raw-component"]),t(G,{"raw-component":n(j)},{title:o(()=>[...p[2]||(p[2]=[a(" With Textarea ",-1)])]),example:o(()=>[t(N)]),_:1},8,["raw-component"])])]))}});export{un as default};
