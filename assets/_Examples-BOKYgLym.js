...
`,O={class:"@container max-w-200 mx-auto"},A={class:"grid grid-cols-1 @xl:grid-cols-2 gap-8 mx-auto"},ie=p({__name:"_Examples",setup(d){return(s,t)=>(u(),m("div",O,[l("div",A,[a(F,{"raw-component":e(U)},{title:n(()=>[...t[0]||(t[0]=[o(" With form ",-1)])]),example:n(()=>[a(z)]),_:1},8,["raw-component"]),a(F,{"raw-component":e(V)},{title:n(()=>[...t[1]||(t[1]=[o(" With sides ",-1)])]),example:n(()=>[a(P)]),_:1},8,["raw-component"])])]))}});export{ie as default};
