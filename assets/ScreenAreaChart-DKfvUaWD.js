import{_ as w}from"./ExampleCard.vue_vue_type_script_setup_true_lang-DbPjP-za.js";import{F as K,_ as y,C as x,D as v,E as _}from"./index-UOI_LXtT.js";import{_ as L,a as T}from"./CardContent.vue_vue_type_script_setup_true_lang-DLnF1Kjg.js";import{_ as A,a as S}from"./CardTitle.vue_vue_type_script_setup_true_lang-CdYPRBz7.js";import{_ as V}from"./CardHeader.vue_vue_type_script_setup_true_lang-DAlhlSWD.js";import{f as B,d as u,g as z,o as b,z as D,T as H,u as e,a7 as R,L as N,M as j,e as C,R as E,C as O,I as r,B as q,J as P,c as U,b as X,H as o,D as t,A as m}from"./highlight-DXRdThM2.js";import{_ as Q,a as W,b as Z,c as I}from"./SelectTrigger.vue_vue_type_script_setup_true_lang-BC0CzVi6.js";import{_ as ee}from"./SelectValue.vue_vue_type_script_setup_true_lang-Kd3ya311.js";import{b as $,C as k,A as M}from"./index-ycBxTstU.js";import{C as J}from"./index-EZDHsOIT.js";import{C as G}from"./index-BQFHNj6o.js";import{_ as F}from"./CardFooter.vue_vue_type_script_setup_true_lang-CSXzqezb.js";import{T as g}from"./trending-up-BEC_Xdoo.js";import"./CoppyButton.vue_vue_type_script_setup_true_lang-CIXp-aNu.js";import"./chevron-down-ib_-hS0h.js";import"./Collection-CX6IziOc.js";import"./usePrimitiveElement-DBla2SSk.js";import"./useFocusGuards-4ZXIwemr.js";import"./useTypeahead-W1YZZ-Zj.js";import"./ohash.D__AXeF1-C-E83dC9.js";import"./useFormControl-4XoA_PSt.js";import"./array-BNpUzgbK.js";const te=B("trending-down",[["path",{d:"M16 17h6v-6",key:"t6n2it"}],["path",{d:"m22 17-8.5-8.5-5 5L2 7",key:"x473p"}]]),Y=u({__name:"ChartLegendContent",props:{hideIcon:{type:Boolean},nameKey:{},verticalAlign:{default:"bottom"},class:{}},setup(h){const s=h,{id:i,config:c}=K(),l=U(()=>Object.entries(c.value).map(([a,d])=>({key:s.nameKey||a,itemConfig:c.value[a]}))),n=X("");return z(()=>{n.value=`[data-chart="chart-${i}"]>[data-vis-xy-container]`}),(a,d)=>n.value?(b(),D("div",{key:0,class:H(e(R)("flex items-center justify-center gap-4",h.verticalAlign==="top"?"pb-3":"pt-3",s.class))},[(b(!0),D(N,null,j(l.value,({key:p,itemConfig:f})=>(b(),D("div",{key:p,class:H(e(R)("[&>svg]:text-muted-foreground flex items-center gap-1.5 [&>svg]:h-3 [&>svg]:w-3"))},[f?.icon?(b(),C(E(f?.icon),{key:0})):(b(),D("div",{key:1,class:"h-2 w-2 shrink-0 rounded-[2px]",style:O({backgroundColor:f?.color})},null,4)),r(" "+q(f?.label),1)],2))),128))],2)):P("",!0)}}),ne={class:"grid flex-1 gap-1"},oe=`
...
`,ye={class:"@container/area-chart-examples"},xe={class:"grid grid-cols-1 @4xl:grid-cols-3 gap-4"},je=u({__name:"ScreenAreaChart",setup(h){return(s,i)=>(b(),D("div",ye,[m("div",xe,[t(w,{"raw-component":e(ie),class:"@4xl:col-span-3"},{title:o(()=>[...i[0]||(i[0]=[r("Interactive Area Chart",-1)])]),example:o(()=>[t(ae)]),_:1},8,["raw-component"]),t(w,{"raw-component":e(me)},{title:o(()=>[...i[1]||(i[1]=[r("Area Chart with Icons",-1)])]),example:o(()=>[t(se)]),_:1},8,["raw-component"]),t(w,{"raw-component":e(he)},{title:o(()=>[...i[2]||(i[2]=[r("Area Chart with Gradient",-1)])]),example:o(()=>[t(ke)]),_:1},8,["raw-component"]),t(w,{"raw-component":e(ge)},{title:o(()=>[...i[3]||(i[3]=[r("Area Chart with Custom Axes",-1)])]),example:o(()=>[t(we)]),_:1},8,["raw-component"])])]))}});export{je as default};
