...
`,an={class:"@container max-w-200 mx-auto"},on={class:"grid grid-cols-1 @xl:grid-cols-2 gap-8 mx-auto"},hn=i({__name:"_Examples",setup(p){return(m,d)=>(u(),C("div",an,[r("div",on,[n(S,{"raw-component":o(Q)},{title:t(()=>[...d[0]||(d[0]=[e(" Basic ",-1)])]),example:t(()=>[n(K)]),_:1},8,["raw-component"]),n(S,{"raw-component":o(nn)},{title:t(()=>[...d[1]||(d[1]=[e(" With Groups ",-1)])]),example:t(()=>[n(Y)]),_:1},8,["raw-component"])])]))}});export{hn as default};
