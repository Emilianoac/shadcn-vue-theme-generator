import{_ as u}from"./ExampleCard.vue_vue_type_script_setup_true_lang-BAay4W22.js";import{d,o as l,e as h,H as s,A as t,z as c,L as m,M as _,B as g,D as e,u as n,S as x,I as p,bK as w}from"./highlight-mgC1Gizx.js";import{_ as b}from"./Separator.vue_vue_type_script_setup_true_lang-CLMgwQFt.js";import"./CoppyButton.vue_vue_type_script_setup_true_lang-BeCgPZJC.js";import"./Separator-CnwynMLx.js";const y={class:"p-4"},v={class:"text-sm"},S=d({__name:"ScrollAreaVertical",setup(f){const i=Array.from({length:50}).map((o,r,a)=>`v1.2.0-beta.${a.length-r}`);return(o,r)=>(l(),h(n(x),{class:"mx-auto h-72 w-48 rounded-md border","data-component-x-ray":"ScrollArea"},{default:s(()=>[t("div",y,[r[0]||(r[0]=t("h4",{class:"mb-4 text-sm leading-none font-medium"},"Tags",-1)),(l(!0),c(m,null,_(n(i),a=>(l(),c(m,{key:a},[t("div",v,g(a),1),e(n(b),{class:"my-2","data-component-x-ray":"Separator"})],64))),128))])]),_:1}))}}),A=`<script setup lang="ts">
