...
`,Pe={class:"flex flex-wrap items-center justify-center gap-4"},Te={class:"flex flex-col gap-1"},Oe={class:"text-sm"},Re=c({__name:"HoverCardSides",setup(l){const o=["top","right","bottom","left"];return(t,r)=>(f(),T("div",Pe,[(f(),T(le,null,de(o,u=>i(e(A),{key:u,"open-delay":100,"close-delay":100,"data-component-x-ray":"HoverCard"},{default:a(()=>[i(e(z),{"as-child":!0},{default:a(()=>[i(e(P),{variant:"outline",class:"capitalize","data-component-x-ray-trigger":"Button"},{default:a(()=>[D($(u),1)]),_:2},1024)]),_:2},1024),i(e(L),{side:u,class:"w-64","data-component-x-ray":"HoverCardContent"},{default:a(()=>[H("div",Te,[r[0]||(r[0]=H("h4",{class:"font-semibold"},"Hover Card",-1)),H("p",Oe,"This hover card appears on the "+$(u)+" side of the trigger.",1)])]),_:2},1032,["side"])]),_:2},1024)),64))]))}}),Ee=`<script setup lang="ts">
import { Button } from "@/shared/components/ui/button";
import { HoverCard, HoverCardContent, HoverCardTrigger } from "@/shared/components/ui/hover-card";
...
`,$e={class:"@container max-w-200 mx-auto"},ke={class:"grid grid-cols-1 @xl:grid-cols-2 gap-8 mx-auto"},Me=c({__name:"_Examples",setup(l){return(o,t)=>(f(),T("div",$e,[H("div",ke,[i(E,{"raw-component":e(Se)},{title:a(()=>[...t[0]||(t[0]=[D(" In Dialog ",-1)])]),example:a(()=>[i(qe)]),_:1},8,["raw-component"]),i(E,{"raw-component":e(Ee)},{title:a(()=>[...t[1]||(t[1]=[D(" Sides ",-1)])]),example:a(()=>[i(Re)]),_:1},8,["raw-component"])])]))}});export{Me as default};
