import{_ as f}from"./ExampleCard.vue_vue_type_script_setup_true_lang-CeNp3otK.js";import{_ as F,a as H,b as J}from"./TooltipTrigger.vue_vue_type_script_setup_true_lang-DnIH10oF.js";import{_ as X}from"./TooltipProvider.vue_vue_type_script_setup_true_lang-DYzeRVuw.js";import{d as C,o as c,a as u,H as o,D as n,u as t,I as s,A as i,V as Y,z as L,L as B,M as U,T as N,B as M,J as E}from"./DialogTitle.vue_vue_type_script_setup_true_lang-B-mIWQEK.js";import{_ as x,C as g,D as y,E as b}from"./index-C467LBtH.js";import{_ as k,a as D}from"./CardContent.vue_vue_type_script_setup_true_lang-1yzKGOUD.js";import{_ as v,a as _,b as w}from"./CardTitle.vue_vue_type_script_setup_true_lang-CkpRWa03.js";import{_ as T}from"./CardFooter.vue_vue_type_script_setup_true_lang-D_xaDoQS.js";import{b as S,C as p,A}from"./index-C3Hooj7t.js";import{C as R}from"./index-htebpgYl.js";import{C as $,a as G}from"./index-CAErU3Hm.js";import{T as V}from"./trending-up-CYbtcqHT.js";import{A as z}from"./index-PP7C5UtJ.js";import{b as P,E as q,D as K}from"./index-D5H_9_gH.js";import"./CoppyButton.vue_vue_type_script_setup_true_lang-Cf2txUt2.js";import"./check-CQT1JKGP.js";import"./PopperContent-ClNHsZFH.js";import"./useSize-Hxodz3uf.js";import"./VisuallyHidden-fIfXuLIO.js";import"./defu-cjemX7BB.js";import"./_commonjsHelpers-CqkleIqs.js";import"./array-BNpUzgbK.js";import"./path-BYvMW87q.js";const O={class:"flex w-full items-start gap-2 text-sm"},I={class:"grid gap-2"},j={class:"flex items-center gap-2 leading-none font-medium"},Q=C({__name:"ChartArea",setup(h){const l=[{month:1,monthLabel:"January",desktop:186},{month:2,monthLabel:"February",desktop:305},{month:3,monthLabel:"March",desktop:237},{month:4,monthLabel:"April",desktop:73},{month:5,monthLabel:"May",desktop:209},{month:6,monthLabel:"June",desktop:214}],r={desktop:{label:"Desktop",color:"var(--chart-1)"}};return(m,e)=>(c(),u(t(D),{"data-component-x-ray":"Card"},{default:o(()=>[n(t(v),{"data-component-x-ray":"CardHeader"},{default:o(()=>[n(t(_),{"data-component-x-ray":"CardTitle"},{default:o(()=>[...e[0]||(e[0]=[s("Area Chart",-1)])]),_:1}),n(t(w),{"data-component-x-ray":"CardDescription"},{default:o(()=>[...e[1]||(e[1]=[s(" Showing total visitors for the last 6 months ",-1)])]),_:1})]),_:1}),n(t(k),{"data-component-x-ray":"CardContent"},{default:o(()=>[n(t(x),{config:r,"data-component-x-ray":"ChartContainer"},{default:o(()=>[n(t(S),{data:l,"data-component-x-ray":"VisXYContainer"},{default:o(()=>[n(t(R),{x:a=>a.month,y:[a=>a.desktop],color:(a,d)=>[r.desktop.color][d],opacity:.4},null,8,["x","y","color"]),n(t($),{x:a=>a.month,y:[a=>a.desktop],color:(a,d)=>[r.desktop.color][d],"line-width":1},null,8,["x","y","color"]),n(t(p),{type:"x",x:a=>a.month,"tick-line":!1,"domain-line":!1,"grid-line":!1,"num-ticks":6,"tick-format":(a,d)=>l[d]?.monthLabel.slice(0,3)},null,8,["x","tick-format"]),n(t(g)),n(t(A),{template:t(y)(r,t(b),{labelKey:"monthLabel"}),color:(a,d)=>[r.desktop.color][d%2]},null,8,["template","color"])]),_:1})]),_:1})]),_:1}),n(t(T),null,{default:o(()=>[i("div",O,[i("div",I,[i("div",j,[e[2]||(e[2]=s(" Trending up by 5.2% this month ",-1)),n(t(V),{class:"h-4 w-4"})]),e[3]||(e[3]=i("div",{class:"text-muted-foreground flex items-center gap-2 leading-none"}," January - June 2024 ",-1))])])]),_:1})]),_:1}))}}),W=`<script setup lang="ts">
...
`,dt={class:"@container w-250 mx-auto"},lt={class:"grid grid-cols-1 @xl:grid-cols-2 gap-8 mx-auto"},ct={key:0,class:"col-span-2 space-y-4"},mt={class:"flex items-center gap-3"},pt=["onClick"],Bt=C({__name:"_Examples",setup(h){const{isActive:l}=Y(),r=[{name:"chart-1",className:"bg-chart-1"},{name:"chart-2",className:"bg-chart-2"},{name:"chart-3",className:"bg-chart-3"},{name:"chart-4",className:"bg-chart-4"},{name:"chart-5",className:"bg-chart-5"}];function m(e){window.setTimeout(()=>{window.dispatchEvent(new CustomEvent("xray:focus-theme-color",{detail:{themeKey:e}}))},0)}return(e,a)=>(c(),L("div",dt,[i("div",lt,[t(l)?(c(),L("div",ct,[a[0]||(a[0]=i("div",null,[i("h2",{class:"text-xl font-semibold"},"Charts colors"),i("p",{class:"text-muted-foreground text-sm"},"Go to chart colors in theme editor")],-1)),i("div",mt,[(c(),L(B,null,U(r,d=>n(t(X),{key:d.name},{default:o(()=>[n(t(F),null,{default:o(()=>[n(t(H),{"as-child":""},{default:o(()=>[i("div",{class:N(["w-5 h-5 rounded-sm hover:opacity-70 cursor-pointer",d.className]),onClick:Ct=>m(d.name)},null,10,pt)]),_:2},1024),n(t(J),null,{default:o(()=>[i("p",null,M(`${d} color`),1)]),_:2},1024)]),_:2},1024)]),_:2},1024)),64))])])):E("",!0),n(f,{"raw-component":t(W)},{title:o(()=>[...a[1]||(a[1]=[s(" Area Chart ",-1)])]),example:o(()=>[n(Q)]),_:1},8,["raw-component"]),n(f,{"raw-component":t(nt)},{title:o(()=>[...a[2]||(a[2]=[s(" Bar Chart ",-1)])]),example:o(()=>[n(tt)]),_:1},8,["raw-component"]),n(f,{"raw-component":t(et)},{title:o(()=>[...a[3]||(a[3]=[s(" Line Chart ",-1)])]),example:o(()=>[n(ot)]),_:1},8,["raw-component"]),n(f,{"raw-component":t(st)},{title:o(()=>[...a[4]||(a[4]=[s(" Pie Chart ",-1)])]),example:o(()=>[n(it)]),_:1},8,["raw-component"])])]))}});export{Bt as default};
