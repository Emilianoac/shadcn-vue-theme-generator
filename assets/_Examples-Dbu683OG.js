...
<style lang="postcss" scoped></style>
`,B={class:"max-w-150 mx-auto space-y-6"},N=g({__name:"_Examples",setup(h){return(s,a)=>(i(),o("div",B,[r(f,{"raw-component":t(k)},{title:e(()=>[...a[0]||(a[0]=[c("Basic",-1)])]),example:e(()=>[r(x)]),_:1},8,["raw-component"]),r(f,{"raw-component":t(T)},{title:e(()=>[...a[1]||(a[1]=[c("Multiple",-1)])]),example:e(()=>[r(I)]),_:1},8,["raw-component"]),r(f,{"raw-component":t(C)},{title:e(()=>[...a[2]||(a[2]=[c("With Disabled",-1)])]),example:e(()=>[r(O)]),_:1},8,["raw-component"])]))}});export{N as default};
