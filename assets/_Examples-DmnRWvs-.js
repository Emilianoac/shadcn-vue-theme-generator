...
`,Ge={class:"@container max-w-200 mx-auto"},Je={class:"grid grid-cols-1 @xl:grid-cols-2 gap-8 mx-auto"},lt=m({__name:"_Examples",setup(o){return(a,t)=>(i(),R("div",Ge,[E("div",Je,[x(ee,{"raw-component":e(We),class:"col-span-1 @xl:col-span-2"},{title:p(()=>[...t[0]||(t[0]=[P(" Basic ",-1)])]),example:p(()=>[x(Ue)]),_:1},8,["raw-component"])])]))}});export{lt as default};
