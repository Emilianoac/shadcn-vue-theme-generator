import{_ as u}from"./ExampleCard.vue_vue_type_script_setup_true_lang-DM92uT3q.js";import{d,o as i,a as _,H as s,A as t,z as c,L as m,M as h,B as g,D as e,u as n,S as x,I as p,bI as w}from"./DialogTitle.vue_vue_type_script_setup_true_lang-C_9FSQhf.js";import{_ as b}from"./Separator.vue_vue_type_script_setup_true_lang-CkQLBTai.js";import"./CoppyButton.vue_vue_type_script_setup_true_lang-C44kN4yO.js";import"./TooltipTrigger.vue_vue_type_script_setup_true_lang-CxLZ1jLL.js";import"./VisuallyHidden-CLlRR9c8.js";import"./Separator-g-U8SaYn.js";const y={class:"p-4"},v={class:"text-sm"},S=d({__name:"ScrollAreaVertical",setup(f){const l=Array.from({length:50}).map((o,r,a)=>`v1.2.0-beta.${a.length-r}`);return(o,r)=>(i(),_(n(x),{class:"mx-auto h-72 w-48 rounded-md border","data-component-x-ray":"ScrollArea"},{default:s(()=>[t("div",y,[r[0]||(r[0]=t("h4",{class:"mb-4 text-sm leading-none font-medium"},"Tags",-1)),(i(!0),c(m,null,h(n(l),a=>(i(),c(m,{key:a},[t("div",v,g(a),1),e(n(b),{class:"my-2","data-component-x-ray":"Separator"})],64))),128))])]),_:1}))}}),A=`<script setup lang="ts">
...
`,H={class:"@container max-w-200 mx-auto"},P={class:"grid grid-cols-1 @xl:grid-cols-2 gap-8 mx-auto"},L=d({__name:"_Examples",setup(f){return(l,o)=>(i(),c("div",H,[t("div",P,[e(u,{"raw-component":n(A)},{title:s(()=>[...o[0]||(o[0]=[p(" Vertical ",-1)])]),example:s(()=>[e(S)]),_:1},8,["raw-component"]),e(u,{"raw-component":n(T)},{title:s(()=>[...o[1]||(o[1]=[p(" Horizontal ",-1)])]),example:s(()=>[e(z)]),_:1},8,["raw-component"])])]))}});export{L as default};
