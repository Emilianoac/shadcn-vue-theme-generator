import{_ as m}from"./ExampleCard.vue_vue_type_script_setup_true_lang-Bw_I79uB.js";import{d as r,o as p,z as d,T as i,u as n,a6 as k,D as e,A as c,a as _,H as o,I as x}from"./DialogTitle.vue_vue_type_script_setup_true_lang-DBPyUkvP.js";import{_ as S,a as f}from"./CardContent.vue_vue_type_script_setup_true_lang-0QRPjMvC.js";import{_ as u}from"./CardHeader.vue_vue_type_script_setup_true_lang-DD-BxvA3.js";import"./CoppyButton.vue_vue_type_script_setup_true_lang-D5HAnf0P.js";const t=r({__name:"Skeleton",props:{class:{}},setup(l){const s=l;return(a,G)=>(p(),d("div",{"data-slot":"skeleton",class:i(n(k)("animate-pulse rounded-md bg-primary/10",s.class))},null,2))}}),w={class:"flex w-full items-center gap-4"},h={class:"grid gap-2"},y=r({__name:"SkeletonAvatar",setup(l){return(s,a)=>(p(),d("div",w,[e(n(t),{class:"size-10 shrink-0 rounded-full","data-component-x-ray":"Skeleton"}),c("div",h,[e(n(t),{class:"h-4 w-37.5","data-component-x-ray":"Skeleton"}),e(n(t),{class:"h-4 w-25","data-component-x-ray":"Skeleton"})])]))}}),v=`<script setup lang="ts">
