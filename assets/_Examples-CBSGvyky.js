import{_ as y}from"./ExampleCard.vue_vue_type_script_setup_true_lang-Bw_I79uB.js";import{d as m,af as R,aA as h,w as $,n as B,o as i,a as f,H as r,a3 as v,u as e,am as M,c as L,bd as T,an as S,a5 as N,ai as k,D as o,C as q,a6 as V,j as E,z as c,r as A,A as P,T as w,L as U,M as j,I as _,B as C}from"./DialogTitle.vue_vue_type_script_setup_true_lang-DBPyUkvP.js";import{_ as G}from"./index-B4qjL25a.js";import{_ as z}from"./FieldLabel.vue_vue_type_script_setup_true_lang-BcLvcLmX.js";import{_ as D}from"./Slider.vue_vue_type_script_setup_true_lang-DvcLZk7h.js";import{i as W,_ as O,a as F,b as X}from"./index-D8nbd5bA.js";import{F as H}from"./file-CM1veXMu.js";import"./CoppyButton.vue_vue_type_script_setup_true_lang-D5HAnf0P.js";import"./Label.vue_vue_type_script_setup_true_lang-B68UebqL.js";import"./useFormControl-GfOjOtjt.js";import"./Collection-B0sjwPP0.js";import"./usePrimitiveElement-DijCEuh6.js";import"./VisuallyHiddenInput-Dd-s1NAa.js";const x=100,[J,K]=S("ProgressRoot"),I=t=>typeof t=="number";function Q(t,s){return T(t)||I(t)&&!Number.isNaN(t)&&t<=s&&t>=0?t:(console.error(`Invalid prop \`value\` of value \`${t}\` supplied to \`ProgressRoot\`. The \`value\` prop must be:
  - a positive number
...
`,ve={class:"@container max-w-200 mx-auto"},ye={class:"grid grid-cols-1 @xl:grid-cols-2 gap-8 mx-auto"},Ne=m({__name:"_Examples",setup(t){return(s,a)=>(i(),c("div",ve,[P("div",ye,[o(y,{"raw-component":e(ne)},{title:r(()=>[...a[0]||(a[0]=[_(" Progress Bar ",-1)])]),example:r(()=>[o(oe)]),_:1},8,["raw-component"]),o(y,{"raw-component":e(le)},{title:r(()=>[...a[1]||(a[1]=[_(" With Label ",-1)])]),example:r(()=>[o(re)]),_:1},8,["raw-component"]),o(y,{"raw-component":e(pe)},{title:r(()=>[...a[2]||(a[2]=[_(" Controlled ",-1)])]),example:r(()=>[o(me)]),_:1},8,["raw-component"]),o(y,{"raw-component":e(xe)},{title:r(()=>[...a[3]||(a[3]=[_(" File Upload List ",-1)])]),example:r(()=>[o(_e)]),_:1},8,["raw-component"])])]))}});export{Ne as default};
