import{_ as d}from"./ExampleCard.vue_vue_type_script_setup_true_lang-DbPjP-za.js";import{d as i,aj as v,ak as b,o as s,e as y,H as l,a4 as B,ah as w,ai as I,a6 as z,u as a,a7 as $,z as p,D as t,I as o,A as V}from"./highlight-DXRdThM2.js";import{t as S,T as P}from"./index-DOFBWMfe.js";import{B as m,I as c,U as k}from"./underline-CUv3NxlC.js";import"./CoppyButton.vue_vue_type_script_setup_true_lang-CIXp-aNu.js";import"./useFormControl-4XoA_PSt.js";import"./VisuallyHiddenInput-UsrU_XqS.js";import"./usePrimitiveElement-DBla2SSk.js";import"./useSingleOrMultipleValue-BuFQNEQc.js";import"./isValueEqualOrExist-Cli9G3Za.js";import"./ohash.D__AXeF1-C-E83dC9.js";import"./RovingFocusGroup-c-SW99X5.js";import"./Collection-CX6IziOc.js";import"./utils-Cjg6PTZ9.js";const n=i({__name:"Toggle",props:{defaultValue:{type:Boolean},modelValue:{type:[Boolean,null]},disabled:{type:Boolean,default:!1},asChild:{type:Boolean},as:{},name:{},required:{type:Boolean},class:{},variant:{default:"default"},size:{default:"default"}},emits:["update:modelValue"],setup(r,{emit:g}){const e=r,u=g,T=v(e,"class","size","variant"),f=b(T,u);return(x,F)=>(s(),y(a(P),z({"data-slot":"toggle"},a(f),{class:a($)(a(S)({variant:r.variant,size:r.size}),e.class)}),{default:l(_=>[B(x.$slots,"default",w(I(_)))]),_:3},16,["class"]))}}),O={class:"flex flex-wrap items-center gap-2"},R=i({__name:"ToggleBasic",setup(r){return(g,e)=>(s(),p("div",O,[t(a(n),{"aria-label":"Toggle bold","default-pressed":!0,"data-component-x-ray-trigger":"Toggle"},{default:l(()=>[t(a(m))]),_:1}),t(a(n),{"aria-label":"Toggle italic","data-component-x-ray-trigger":"Toggle"},{default:l(()=>[t(a(c))]),_:1}),t(a(n),{"aria-label":"Toggle underline","data-component-x-ray-trigger":"Toggle"},{default:l(()=>[t(a(k))]),_:1})]))}}),U=`<script setup lang="ts">
