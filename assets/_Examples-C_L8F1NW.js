import{_ as y}from"./ExampleCard.vue_vue_type_script_setup_true_lang-C8cUG3aI.js";import{f as g,d as p,o as m,z as u,T as x,u as e,a8 as f,a5 as v,at as T,D as n,H as a,I as r,A}from"./highlight-CeYIOz-i.js";import"./CoppyButton.vue_vue_type_script_setup_true_lang-z5jP3Qrf.js";const c=g("circle-alert",[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["line",{x1:"12",x2:"12",y1:"8",y2:"12",key:"1pkeuh"}],["line",{x1:"12",x2:"12.01",y1:"16",y2:"16",key:"4dfq90"}]]),i=p({__name:"Alert",props:{class:{},variant:{}},setup(l){const s=l;return(t,h)=>(m(),u("div",{"data-slot":"alert",class:x(e(f)(e(_)({variant:l.variant}),s.class)),role:"alert"},[v(t.$slots,"default")],2))}}),d=p({__name:"AlertDescription",props:{class:{}},setup(l){const s=l;return(t,h)=>(m(),u("div",{"data-slot":"alert-description",class:x(e(f)("text-muted-foreground col-start-2 text-sm [&_p]:leading-relaxed",s.class))},[v(t.$slots,"default")],2))}}),o=p({__name:"AlertTitle",props:{class:{}},setup(l){const s=l;return(t,h)=>(m(),u("div",{"data-slot":"alert-title",class:x(e(f)("col-start-2 line-clamp-1 min-h-4 font-medium tracking-tight",s.class))},[v(t.$slots,"default")],2))}}),_=T("relative w-full rounded-lg border px-4 py-3 text-sm grid has-[>svg]:grid-cols-[calc(var(--spacing)*4)_1fr] grid-cols-[0_1fr] has-[>svg]:gap-x-3 gap-y-0.5 items-start [&>svg]:size-4 [&>svg]:translate-y-0.5 [&>svg]:text-current",{variants:{variant:{default:"bg-card text-card-foreground",destructive:"text-destructive bg-card [&>svg]:text-current *:data-[slot=alert-description]:text-destructive/90"}},defaultVariants:{variant:"default"}}),w={class:"space-y-5"},D=p({__name:"AlertBasic",setup(l){return(s,t)=>(m(),u("div",w,[n(e(i),{variant:"default","data-component-x-ray":"Alert"},{default:a(()=>[n(e(o),{"data-component-x-ray":"AlertTitle"},{default:a(()=>[...t[0]||(t[0]=[r(" Success! Your changes have been saved ",-1)])]),_:1})]),_:1}),n(e(i),{variant:"default","data-component-x-ray":"Alert"},{default:a(()=>[n(e(o),{"data-component-x-ray":"AlertTitle"},{default:a(()=>[...t[1]||(t[1]=[r(" Success! Your changes have been saved ",-1)])]),_:1}),n(e(d),{"data-component-x-ray":"AlertDescription"},{default:a(()=>[...t[2]||(t[2]=[r(" This is an alert with title and description ",-1)])]),_:1})]),_:1}),n(e(i),{variant:"default","data-component-x-ray":"Alert"},{default:a(()=>[n(e(d),{"data-component-x-ray":"AlertDescription"},{default:a(()=>[...t[3]||(t[3]=[r(" This one has a description only. No title. No icon. ",-1)])]),_:1})]),_:1})]))}}),b=`<script lang="ts" setup>
...
<style lang="postcss" scoped></style>
`,N={class:"max-w-150 mx-auto space-y-6"},E=p({__name:"_Examples",setup(l){return(s,t)=>(m(),u("div",N,[n(y,{"raw-component":e(b)},{title:a(()=>[...t[0]||(t[0]=[r("Basic",-1)])]),example:a(()=>[n(D)]),_:1},8,["raw-component"]),n(y,{"raw-component":e($)},{title:a(()=>[...t[1]||(t[1]=[r("With Icons",-1)])]),example:a(()=>[n(C)]),_:1},8,["raw-component"]),n(y,{"raw-component":e(Y)},{title:a(()=>[...t[2]||(t[2]=[r("Destructive",-1)])]),example:a(()=>[n(S)]),_:1},8,["raw-component"])]))}});export{E as default};
