...
`,$e={class:"@container max-w-250 mx-auto"},ke={class:"grid grid-cols-1 @xl:grid-cols-2 gap-8 mx-auto"},Ge=c({__name:"_Examples",setup(l){return(o,t)=>(f(),P("div",$e,[H("div",ke,[i(E,{"raw-component":e(Se)},{title:a(()=>[...t[0]||(t[0]=[D(" In Dialog ",-1)])]),example:a(()=>[i(qe)]),_:1},8,["raw-component"]),i(E,{"raw-component":e(Ee)},{title:a(()=>[...t[1]||(t[1]=[D(" Sides ",-1)])]),example:a(()=>[i(Re)]),_:1},8,["raw-component"])])]))}});export{Ge as default};
