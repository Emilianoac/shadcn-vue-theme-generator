...
<style lang="postcss" scoped></style>
`,N={class:"max-w-150 mx-auto space-y-6"},q=p({__name:"_Examples",setup(l){return(s,t)=>(m(),u("div",N,[n(y,{"raw-component":e(b)},{title:a(()=>[...t[0]||(t[0]=[r("Basic",-1)])]),example:a(()=>[n(D)]),_:1},8,["raw-component"]),n(y,{"raw-component":e($)},{title:a(()=>[...t[1]||(t[1]=[r("With Icons",-1)])]),example:a(()=>[n(C)]),_:1},8,["raw-component"]),n(y,{"raw-component":e(Y)},{title:a(()=>[...t[2]||(t[2]=[r("Destructive",-1)])]),example:a(()=>[n(S)]),_:1},8,["raw-component"])]))}});export{q as default};
