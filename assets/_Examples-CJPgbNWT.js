...
`,Y={class:"@container max-w-200 mx-auto"},H={class:"grid grid-cols-1 @xl:grid-cols-2 gap-8 mx-auto"},fn=_({__name:"_Examples",setup(T){return(u,t)=>(s(),c("div",Y,[D("div",H,[e(G,{"raw-component":n(U)},{title:o(()=>[...t[0]||(t[0]=[i(" Basic ",-1)])]),example:o(()=>[e(F)]),_:1},8,["raw-component"]),e(G,{"raw-component":n(K)},{title:o(()=>[...t[1]||(t[1]=[i(" Groups ",-1)])]),example:o(()=>[e(R)]),_:1},8,["raw-component"])])]))}});export{fn as default};
