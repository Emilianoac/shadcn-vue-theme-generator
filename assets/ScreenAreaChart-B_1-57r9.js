import{_ as w}from"./ExampleCard.vue_vue_type_script_setup_true_lang-Dv0Lwgv7.js";import{F as K,_ as y,C as x,D as v,E as _}from"./index-C5eRc9qR.js";import{_ as L,a as T}from"./CardContent.vue_vue_type_script_setup_true_lang-D8yqQyCJ.js";import{_ as A,a as S}from"./CardTitle.vue_vue_type_script_setup_true_lang-82btzTyW.js";import{_ as V}from"./CardHeader.vue_vue_type_script_setup_true_lang-DmUrV1xQ.js";import{g as B,d as h,j,o as b,z as D,T as H,u as e,a6 as R,L as z,M as N,a as C,R as E,C as O,I as r,B as q,J as P,c as U,r as X,H as o,D as t,A as m}from"./DialogTitle.vue_vue_type_script_setup_true_lang-CaMH5FGq.js";import{_ as Q,a as W,b as Z,c as I}from"./SelectTrigger.vue_vue_type_script_setup_true_lang-CGMRsfoI.js";import{_ as ee}from"./SelectValue.vue_vue_type_script_setup_true_lang-SHCa2Wud.js";import{b as $,C as k,A as M}from"./index-DALPYjz_.js";import{C as J}from"./index-DM60V_Fx.js";import{C as G}from"./index-Cjv26ReU.js";import{_ as F}from"./CardFooter.vue_vue_type_script_setup_true_lang-DXTO8qGL.js";import{T as g}from"./trending-up-DYmrPrwL.js";import"./CoppyButton.vue_vue_type_script_setup_true_lang-DIiXhJ1v.js";import"./_commonjsHelpers-CqkleIqs.js";import"./chevron-down-BK9fKQsP.js";import"./Collection-C_HKjXdo.js";import"./usePrimitiveElement-30gr_7Mg.js";import"./useFocusGuards-BaiBm_8F.js";import"./useTypeahead-49jAzyI6.js";import"./ohash.D__AXeF1-C-E83dC9.js";import"./useFormControl-DtVoYA5l.js";import"./array-BNpUzgbK.js";const te=B("trending-down",[["path",{d:"M16 17h6v-6",key:"t6n2it"}],["path",{d:"m22 17-8.5-8.5-5 5L2 7",key:"x473p"}]]),Y=h({__name:"ChartLegendContent",props:{hideIcon:{type:Boolean},nameKey:{},verticalAlign:{default:"bottom"},class:{}},setup(u){const s=u,{id:i,config:c}=K(),l=U(()=>Object.entries(c.value).map(([a,d])=>({key:s.nameKey||a,itemConfig:c.value[a]}))),n=X("");return j(()=>{n.value=`[data-chart="chart-${i}"]>[data-vis-xy-container]`}),(a,d)=>n.value?(b(),D("div",{key:0,class:H(e(R)("flex items-center justify-center gap-4",u.verticalAlign==="top"?"pb-3":"pt-3",s.class))},[(b(!0),D(z,null,N(l.value,({key:p,itemConfig:f})=>(b(),D("div",{key:p,class:H(e(R)("[&>svg]:text-muted-foreground flex items-center gap-1.5 [&>svg]:h-3 [&>svg]:w-3"))},[f?.icon?(b(),C(E(f.icon),{key:0})):(b(),D("div",{key:1,class:"h-2 w-2 shrink-0 rounded-[2px]",style:O({backgroundColor:f.color})},null,4)),r(" "+q(f?.label),1)],2))),128))],2)):P("",!0)}}),ne={class:"grid flex-1 gap-1"},oe=`
...
`,ye={class:"@container/area-chart-examples"},xe={class:"grid grid-cols-1 @4xl:grid-cols-3 gap-4"},Ee=h({__name:"ScreenAreaChart",setup(u){return(s,i)=>(b(),D("div",ye,[m("div",xe,[t(w,{"raw-component":e(ie),class:"@4xl:col-span-3"},{title:o(()=>[...i[0]||(i[0]=[r("Interactive Area Chart",-1)])]),example:o(()=>[t(ae)]),_:1},8,["raw-component"]),t(w,{"raw-component":e(me)},{title:o(()=>[...i[1]||(i[1]=[r("Area Chart with Icons",-1)])]),example:o(()=>[t(se)]),_:1},8,["raw-component"]),t(w,{"raw-component":e(ue)},{title:o(()=>[...i[2]||(i[2]=[r("Area Chart with Gradient",-1)])]),example:o(()=>[t(ke)]),_:1},8,["raw-component"]),t(w,{"raw-component":e(ge)},{title:o(()=>[...i[3]||(i[3]=[r("Area Chart with Custom Axes",-1)])]),example:o(()=>[t(we)]),_:1},8,["raw-component"])])]))}});export{Ee as default};
